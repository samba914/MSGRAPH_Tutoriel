...
[start=7]
7. The function https://github.com/oliviercailloux-org/dep-git-Teach_spreadsheets/blob/f9c1ae6da79bafc332892e20e214f56c17f8dc26/src/main/java/io/github/oliviercailloux/teach_spreadsheets/online/read/WorksheetReader.java#L54[getCellValue] will allow you to get the value of a cell.
